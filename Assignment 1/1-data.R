...
## List of Operation
## 1. Select two columns i.e. X and Grad.Rate from df collection and storing in result
## 2. Applying a filter to selected column Grad.Rate that has Grad.Rate value greater or equal to 80  and storing in result
## 3. Ordering the filter columns in descending order of Grad.Rate and storing in result
## 4. Display final result

result <- select(df, X, Grad.Rate)
result <- filter(result, Grad.Rate >= 80)
result <- arrange(result, desc(Grad.Rate)) 
result
...
## DF:
## List of operation
## 1. Grouping data of df 
## 2. Summarise the dfx as per min and max of grouping data of df and storing it
## 3. Display the summarise data
...
## college:
## List of operation
## 1. Grouping data of college 
## 2. Summarise the dfx as per min and max of grouping data of college and storing it
## 3. Display the summarise data
